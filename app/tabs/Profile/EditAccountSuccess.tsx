...
export default function EditAccountSuccess() {
  ...
  return (
    <View className='bg-[#B33939]'>
      ...
      <View className='w-full h-full px-12 py-5 rounded-t-2xl bg-[#FFFFFF] round-2xl'>
        ...
        <View className='pt-20'>
          <Pressable className='bg-[#D9534F] py-3 rounded-md' onPress={() => router.replace('../')}>
