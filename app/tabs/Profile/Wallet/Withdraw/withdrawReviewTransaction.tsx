        ...
        <View className='px-6'>
          ...
          <View className='px-6 pt-10 mb-6'>
            ...
            <View className='bg-white flex flex-col space-y-2 p-5 rounded-xl my-2'>
              ...
              <Text className='text-xs text-gray-500'>Book Name: {transferData.senderName}</Text>
              <Text className='text-xs text-gray-500'>Account Number: {transferData.senderEmail}</Text>
              <Text className='text-xs text-gray-500'>Account Holder Name: {transferData.receiptName}</Text>
              <Text className='text-xs text-gray-500'>Email: {transferData.receiptEmail}</Text>
              <Text className='text-xs text-gray-500'>Withdraw Amount: {transferData.transferAmount}</Text>
